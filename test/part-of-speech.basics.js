...
exports['The quick brown fox jumps over the lazy dog.'] = function(test) {
    var expected = [
        ...
        analysis = next.analyse('The quick brown fox jumps over the lazy dog.'),
        actual = [
            analysis[0].tags
        ];
...
exports['A form of asbestos once used to make Kent cigarette filters has caused a high percentage of cancer deaths among a group of workers exposed to it more than 30 years ago, researchers reported.'] = function(test) {
    var expected = [
        ...
        analysis = next.analyse('A form of asbestos once used to make Kent cigarette filters has caused a high percentage of cancer deaths among a group of workers exposed to it more than 30 years ago, researchers reported.'),
        actual = [
            analysis[0].tags
        ];
...
exports['It\'s psychedelic.'] = function(test) {
    var expected = [
        ...
        analysis = next.analyse('It\'s psychedelic.'),
        actual = [analysis[0].tags];
...
exports['I like you'] = function(test) {
    var expected = [
        ...
        analysis = next.analyse('I like you'),
        actual = [analysis[0].tags];
...
exports['The bridge has been damaged'] = function(test) {
    var expected = [
        ...
        analysis = next.analyse('The bridge has been damaged'),
        actual = [analysis[0].tags];
...
exports['Pierre Vinken, 61 years old, will join the board as a nonexecutive director Nov. 29.'] = function(test) {
    var expected = [
        ...
        analysis = next.analyse('Pierre Vinken, 61 years old, will join the board as a nonexecutive director Nov. 29.'),
        actual = [analysis[0].tags];
