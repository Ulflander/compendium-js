...
exports['Hello Mr. Hide.'] = function(test){
    ...
    test.equal(analysis[0].tokens[1].is_abbr, true);
    test.equal(analysis[0].tokens[3].is_abbr, false);
    test.done();
};
...
exports['This is september'] = function(test){
    ...
    test.equal(analysis[0].tokens[2].is_abbr, false);
    test.done();
};
...
exports['This is Sept.'] = function(test){
    ...
    test.equal(analysis[0].tokens[2].is_abbr, true);
    test.done();
};
...
exports['I live in wisc. and I love it'] = function(test){
    ...
    test.equal(analysis[0].tokens[3].is_abbr, true);
    test.done();
};