...
exports['yes 😋'] = function(test){
    ...
    test.equal(analysis[0].profiling.label, 'positive');
    test.done();
};
...
exports['yes 😟'] = function(test){
    ...
    test.equal(analysis[0].profiling.label, 'negative');
    test.done();
};
...
exports['"I\'m happy." vs "I\'m happy!" vs "I\'m happy!!!!"'] = function(test) {
    ...
    test.ok(a1[0].profiling.sentiment < a2[0].profiling.sentiment, '1 vs 2');
    test.ok(a1[0].profiling.sentiment < a3[0].profiling.sentiment, '1 vs 3');
    test.ok(a2[0].profiling.sentiment < a3[0].profiling.sentiment, '2 vs 3');
    test.done();
};
