...
exports['Various foreign test cases'] = function(test) {
    var cases = [
...
exports['Various headline test cases'] = function(test) {
    var cases = [
...
exports['Various interrogative test cases'] = function(test) {
    var cases = [
        'uh?',
        'who am i?', 'Who I am?',
...
exports['Various exclamatory test cases'] = function(test) {
    var cases = [
        'do it!', 'yeah!!!'
    ], i, l, analysis;
...
exports['Various imperative test cases'] = function(test) {
    var cases = [
...
exports['Various non approval test cases'] = function(test) {
    var cases = [
        'yes?', 'perfect?', 'mh', 'nope'
    ], i, l, analysis;
